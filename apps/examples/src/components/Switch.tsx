        ...
        <ExampleSection name="sizes">
          <HStack spacing="md">
            <Switch
              ...
              onPress={() => toggle3(!isChecked3)}
            />
            <Switch
              size="sm"
              colorScheme="blue"
              isChecked={isChecked4}
              onPress={() => toggle4(!isChecked4)}
            />
            <Switch
              size="md"
              colorScheme="orange"
              isChecked={isChecked5}
              onPress={() => toggle5(!isChecked5)}
            />
            <Switch
              size="lg"
              colorScheme="purple"
              isChecked={isChecked6}
              onPress={() => toggle6(!isChecked6)}
            />
          </HStack>
        </ExampleSection>
