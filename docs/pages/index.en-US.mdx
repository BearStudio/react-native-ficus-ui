...
<Box w="80vw" marginLeft="calc(-40vw + 50%)">
  <Box
    ...
    alignItems={[undefined, null, null, 'center']}
  >
    <Box flex={0.6} mr={[null, null, null, '1rem']}>
      ```js
      <VStack
        p={10}
        borderWidth={1}
...
<Box w="80vw" marginLeft="calc(-40vw + 50%)" py="2rem">
  ...
  <Box display="flex" flexDirection={['column', null, null, 'row']}>
    <Box flex={0.3} mr={[null, null, null, '1rem']}>
      ```js
      <Box w="100%">
        <Box
          flexDirection="row"
...
<GraySection>
  ...
  <Box display="flex" flexDirection={['column', null, null, 'row']} alignItems={[undefined, null, null, 'center']}>
    <Box flex={0.5} mr={[null, null, null, '1rem']} display="flex" justifyContent="center">
      <Theme />
    </Box>
    <Box flex={0.5} mt={['1rem', null, null, 0]}>
      ```js
      export const Theme = () => {
        const theme = {
          colors: {
