...
describe('IconButton component', () => {
  it('should render default icon with no props', () => {
    const { getByTestId } = render(<IconButton testID="icon-button-no-props" icon={<Icon name="home" />} />);
  ...
  it('should pressing trigger event', () => {
    ...
    const { getByTestId } = render(<IconButton testID="icon-button-press" icon={<Icon name="home" />} onPress={onPressMock} />);
